...
with open('C:/Users/yourName/Documents/Python AI//Api_key.txt', 'r') as f:
...
class OpenAIClient:
    ...
    def __init__(self, api_key=API_KEY, model_name="gpt-4o-mini", max_tokens=4096, system_role_content="You are a helpful assistant.", temperature=.3, top_p=.6):
        """
        ...
        Args:
            ...
            temperature (float): The randomness of the model's responses. Defaults to 1.0.
            top_p (float): The cumulative probability threshold for top-p sampling. Defaults to 1.0.
        """
        import openai
